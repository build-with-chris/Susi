...
import type { ProjectImageComment } from "@/types/database";
import { saveImageComment } from "../../actions";
    ...
    <div>
      ...
      <div className="mt-2 flex items-center gap-2">
        <button
          ...
          className="rounded-lg bg-violet-600 px-4 py-2 text-sm font-medium text-white hover:bg-violet-700 disabled:opacity-50 disabled:hover:bg-violet-600"
        >
